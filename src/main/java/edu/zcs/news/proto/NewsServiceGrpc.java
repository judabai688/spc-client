...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.StringRequest,
      edu.zcs.news.proto.NewsProto.StringReponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = edu.zcs.news.proto.NewsProto.StringRequest.class,
      responseType = edu.zcs.news.proto.NewsProto.StringReponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.StringRequest,
      edu.zcs.news.proto.NewsProto.StringReponse> getHelloMethod() {
    io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.StringRequest, edu.zcs.news.proto.NewsProto.StringReponse> getHelloMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getHelloMethod = NewsServiceGrpc.getHelloMethod) == null) {
          NewsServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<edu.zcs.news.proto.NewsProto.StringRequest, edu.zcs.news.proto.NewsProto.StringReponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.zcs.news.proto.NewsProto.StringRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.zcs.news.proto.NewsProto.StringReponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(edu.zcs.news.proto.NewsProto.StringRequest request,
        io.grpc.stub.StreamObserver<edu.zcs.news.proto.NewsProto.StringReponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                edu.zcs.news.proto.NewsProto.StringRequest,
                edu.zcs.news.proto.NewsProto.StringReponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public edu.zcs.news.proto.NewsProto.StringReponse hello(edu.zcs.news.proto.NewsProto.StringRequest request) {
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.zcs.news.proto.NewsProto.StringReponse> hello(
        edu.zcs.news.proto.NewsProto.StringRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((edu.zcs.news.proto.NewsProto.StringRequest) request,
              (io.grpc.stub.StreamObserver<edu.zcs.news.proto.NewsProto.StringReponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class NewsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.zcs.news.proto.NewsProto.getDescriptor();
    }
